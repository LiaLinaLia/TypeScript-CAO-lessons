...
console.group('2. Aprašykite funkcijų tipus prieš deklaruojant funkcijas');
{
  ...
  // Binary šiaip reiškia dvejetainę skaimenų sistemą ir naudojamas kad f-ja priima 2 parametrus
  type UnaryNumberProduct = (x: number) => number;
  type UnaryStringVoid = (x: string) => void;// kai aprašom išanksto grąžinimas su =>, ki kartu už :
