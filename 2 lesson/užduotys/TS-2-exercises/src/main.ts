...
console.group('1 - https://edabit.com/challenge/nuXdWHAoHv9y38sn7');
{
  ...
  //   }  // eslint siūlo su =>
  const sortDrinksByPrice = (drink1: Drink, drink2: Drink): number => drink1.price - drink2.price;

  const solution = (drinks: Array<Drink>): Array<Drink> => [...drinks].sort(sortDrinksByPrice);
